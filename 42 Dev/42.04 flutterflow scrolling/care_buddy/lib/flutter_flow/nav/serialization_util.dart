    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case StaffDetailsRow:
            return StaffDetailsRow(data);
          case ShiftsRow:
            return ShiftsRow(data);
          case GroupBookingsRow:
            return GroupBookingsRow(data);
          case DocumentTypesRow:
            return DocumentTypesRow(data);
          case UploadedDocumentsRow:
            return UploadedDocumentsRow(data);
          case BookingsRow:
          ...
          case TeamLeadersRow:
            return TeamLeadersRow(data);
          case StaffClientPairingsRow:
            return StaffClientPairingsRow(data);
          default:
            return null;
        }
