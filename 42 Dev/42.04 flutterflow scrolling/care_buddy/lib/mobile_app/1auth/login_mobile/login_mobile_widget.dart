...
import 'login_mobile_model.dart';
export 'login_mobile_model.dart';

class LoginMobileWidget extends StatefulWidget {
  const LoginMobileWidget({super.key});

  @override
  _LoginMobileWidgetState createState() => _LoginMobileWidgetState();
}

class _LoginMobileWidgetState extends State<LoginMobileWidget> {
  late LoginMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginMobileModel());
