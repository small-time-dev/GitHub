...
import 'incidents_model.dart';
export 'incidents_model.dart';

class IncidentsWidget extends StatefulWidget {
  const IncidentsWidget({super.key});

  @override
  _IncidentsWidgetState createState() => _IncidentsWidgetState();
}

class _IncidentsWidgetState extends State<IncidentsWidget> {
  late IncidentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IncidentsModel());
