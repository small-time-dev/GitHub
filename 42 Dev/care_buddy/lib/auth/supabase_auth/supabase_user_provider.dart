...
class CareBuddySupabaseUser extends BaseAuthUser {
  CareBuddySupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> careBuddySupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = CareBuddySupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
