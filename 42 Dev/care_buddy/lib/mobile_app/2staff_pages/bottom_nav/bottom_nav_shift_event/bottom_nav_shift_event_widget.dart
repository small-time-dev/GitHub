...
import 'bottom_nav_shift_event_model.dart';
export 'bottom_nav_shift_event_model.dart';

class BottomNavShiftEventWidget extends StatefulWidget {
  const BottomNavShiftEventWidget({super.key});

  @override
  _BottomNavShiftEventWidgetState createState() =>
      _BottomNavShiftEventWidgetState();
}

class _BottomNavShiftEventWidgetState extends State<BottomNavShiftEventWidget>
    with TickerProviderStateMixin {
  late BottomNavShiftEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomNavShiftEventModel());
